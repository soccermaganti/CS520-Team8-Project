    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-teal-50 to-cyan-50 p-4">
      <div className="relative w-full max-w-md overflow-hidden rounded-xl bg-white p-8 shadow-xl">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-gray-900 md:text-3xl">Login</h1>
        ...
        <div className="mb-6 flex justify-center space-x-4">
          <Button
            ...
            className={userType === "patient" ? "bg-teal-600 hover:bg-teal-700" : ""}
          >
            Patient
          </Button>
          <Button
            ...
            className={userType === "doctor" ? "bg-teal-600 hover:bg-teal-700" : ""}
          >
            Doctor
          </Button>
        </div>
