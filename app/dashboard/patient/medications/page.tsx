...
import { ArrowLeft, Home, User, Calendar, FileText, Pill, CreditCard, Settings, LogOut } from "lucide-react"
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <nav className="flex-1 pt-4">
          <div className="space-y-1">
            ...
            <NavItem href="/dashboard/patient/medications" icon={<Pill />} active>
              Medications
            </NavItem>
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              ...
              <div className="flex justify-end">
                <Button className="bg-teal-600 hover:bg-teal-700">Place Order</Button>
              </div>
            </CardContent>
          </Card>
                  ...
                  <tbody>
                    {currentMedications.map((medication, index) => (
                      <tr key={index} className="border-b border-gray-200">
                        ...
                        <td className="py-3 px-4">{medication.refillsRemaining}</td>
