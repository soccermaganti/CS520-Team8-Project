...
import { ArrowLeft, Home, User, Calendar, FileText, Pill, CreditCard, Settings, LogOut, Send, Plus } from "lucide-react"
  ...
  const conversations = [
    {
      ...
      unread: true,
      messages: [
        { sender: "doctor", content: "Hello USER1, how are you feeling today?", time: "10:25 AM" },
        { sender: "patient", content: "I'm feeling much better, thank you.", time: "10:28 AM" },
        {
          sender: "doctor",
          content: "That's great to hear! Have you been taking your medications regularly?",
          time: "10:30 AM",
        },
      ],
    },
    {
      ...
      unread: false,
      messages: [
        { sender: "doctor", content: "I've reviewed your latest test results.", time: "Yesterday" },
        { sender: "doctor", content: "Everything looks good, no concerns at this time.", time: "Yesterday" },
        { sender: "patient", content: "That's a relief. Thank you doctor.", time: "Yesterday" },
      ],
    },
    {
      id: 3,
      ...
      unread: false,
      messages: [
        { sender: "doctor", content: "Remember to apply the prescribed cream twice daily.", time: "May 15" },
        { sender: "patient", content: "I will. Should I continue if the rash improves?", time: "May 15" },
        { sender: "doctor", content: "Yes, please continue for the full 2 weeks as prescribed.", time: "May 15" },
      ],
    },
    {
      id: 4,
      ...
      unread: false,
      messages: [
        { sender: "nurse", content: "Your appointment for next Tuesday at 2:30 PM is confirmed.", time: "May 10" },
        { sender: "patient", content: "Thank you. Should I bring anything specific?", time: "May 10" },
        { sender: "nurse", content: "Just your insurance card and a list of current medications.", time: "May 10" },
      ],
    },
    {
      id: 5,
      ...
      unread: false,
      messages: [
        { sender: "system", content: "Your lab results from May 3rd are now available.", time: "May 5" },
        {
          sender: "system",
          content:
        ...
        <main className="flex-1 flex overflow-hidden">
              ...
              {conversations.map((conversation, index) => (
                ...
                >
                  <div className="flex items-start">
                    ...
                    {conversation.unread && <div className="w-2 h-2 bg-teal-500 rounded-full ml-2"></div>}
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="flex-1 flex flex-col bg-gray-50">
            ...
            <div className="p-4 bg-white border-b border-gray-200 flex items-center">
              ...
              <div>
                <h4 className="font-medium">{conversations[selectedConversation].name}</h4>
                ...
                >
                  ...
                  <div
                    className={`max-w-[70%] p-3 rounded-lg ${
                      message.sender === "patient" ? "bg-teal-500 text-white" : "bg-white border border-gray-200"
                    }`}
                  >
                    <p>{message.content}</p>
                    <p className={`text-xs mt-1 ${message.sender === "patient" ? "text-teal-100" : "text-gray-500"}`}>
                      {message.time}
                    </p>
                  </div>
                  {message.sender === "patient" && (
