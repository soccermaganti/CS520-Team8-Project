...
import { Bell, Mail, LogOut, User, Calendar, FileText, Users, Clipboard, Settings, Search } from "lucide-react"
      ...
      <div className="w-60 bg-white border-r border-gray-200 flex flex-col">
        ...
        <nav className="flex-1 pt-4">
          <div className="space-y-1">
            ...
            <NavItem href="/dashboard/doctor/prescriptions" icon={<Clipboard />}>
              Prescriptions
            </NavItem>
          </div>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="mb-4">
                    ...
                    {/* Horizontal Tabs */}
                    <Tabs defaultValue="vitals" className="w-full" onValueChange={setActiveHorizontalTab}>
                  ...
                  {activeHorizontalTab === "vitals" && (
                    <div className="space-y-6">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-4">
                              ...
                              <div className="flex items-center space-x-2">
                                <RadioGroup defaultValue="regular">
                                  <div className="flex items-center space-x-2">
                                    <RadioGroupItem value="not-answered" id="pulse-not-answered" />
                                    <Label htmlFor="pulse-not-answered">Not Answered</Label>
                                  </div>
                                </RadioGroup>
                              </div>
                            </div>
                      ...
                      <div className="grid grid-cols-2 gap-8">
                        ...
                        <div>
                          ...
                          <div className="flex items-center mt-1">
                            <Input placeholder="Enter weight" className="mr-4" />
                            <div className="flex items-center space-x-4">
                              <div className="flex items-center space-x-2">
                                <RadioGroup defaultValue="actual">
                                  <div className="flex items-center space-x-2">
                                    <RadioGroupItem value="actual" id="weight-actual" />
                                    <Label htmlFor="weight-actual">Actual</Label>
                                  </div>
                                </RadioGroup>
                              </div>
                              <div className="flex items-center space-x-2">
                                <RadioGroup defaultValue="actual">
                                  <div className="flex items-center space-x-2">
                                    <RadioGroupItem value="stated" id="weight-stated" />
                                    <Label htmlFor="weight-stated">Stated</Label>
                                  </div>
                                </RadioGroup>
                              </div>
                            </div>
                      ...
                      <div>
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-4">
                            ...
                            <div className="flex items-center space-x-2">
                              <RadioGroup defaultValue="oral">
                                <div className="flex items-center space-x-2">
                                  <RadioGroupItem value="rectal" id="temp-rectal" />
                            ...
                            <div className="flex items-center space-x-2">
                              <RadioGroup defaultValue="oral">
                                <div className="flex items-center space-x-2">
                                  <RadioGroupItem value="axillary" id="temp-axillary" />
                                  <Label htmlFor="temp-axillary">Axillary</Label>
                                </div>
                              </RadioGroup>
                            </div>
                            <div className="flex items-center space-x-2">
                              <RadioGroup defaultValue="oral">
                                <div className="flex items-center space-x-2">
                                  <RadioGroupItem value="tympanic" id="temp-tympanic" />
                                  <Label htmlFor="temp-tympanic">Tympanic</Label>
                                </div>
                              </RadioGroup>
                            </div>
                            <div className="flex items-center space-x-2">
                              <RadioGroup defaultValue="oral">
                                <div className="flex items-center space-x-2">
                                  <RadioGroupItem value="not-answered" id="temp-not-answered" />
                                  <Label htmlFor="temp-not-answered">Not Answered</Label>
                                </div>
                              </RadioGroup>
                            </div>
                          </div>
                        ...
                        <div className="flex items-center mt-1">
                          <Input placeholder="Enter temperature" className="mr-4" />
                          <div className="flex items-center space-x-2">
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div>
                          ...
                          <Input className="mt-1" placeholder="Enter respiratory rate" />
                        </div>
                        <div>
                      ...
                      {/* Blood Sugar */}
                      <div>
                        <Label className="text-sm font-medium">Blood Sugar Glucometer</Label>
                        <Input className="mt-1" placeholder="Enter blood sugar level" />
                      </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="infection" className="text-sm">
                            Patient Developed an infection since last visit. Explain:
                          </Label>
                        </div>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="fall" className="text-sm">
                            Patient has had a fall since last visit (describe injury if any)
                          </Label>
                        </div>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="medical-attention" className="text-sm">
                            Medical attention was required for fall (describe medical attention sought for injury)
                          </Label>
                        </div>
